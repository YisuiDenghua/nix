  ...
  outputs = { self, nixpkgs, nixpkgs-regression, lowdown-src }:
    ...
    in {
      ...
      hydraJobs = {
        ...
        # installation script.
        installerScript = installScriptFor [ "x86_64-linux" "i686-linux" "aarch64-linux" "x86_64-darwin" "aarch64-darwin" "armv6l-linux" "armv7l-linux" "riscv64-linux" ];
        installerScriptForGHA = installScriptFor [ "x86_64-linux" "x86_64-darwin" "armv6l-linux" "armv7l-linux" "riscv64-linux" ];
